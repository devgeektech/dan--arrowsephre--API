...
function mvp_share_count() {
	...
	<div class="share-count">
		<?php $soc_tot = get_tweets( $post_id ) + get_fb( $post_id ) + get_plusones( $post_id ) + get_pinterest( $post_id ); if($soc_tot==0) { ?><?php } elseif($soc_tot==1) { ?><span class="social-count-num"><?php echo $soc_tot; ?></span><span class="social-count-text"><?php _e( 'share', 'mvp-text' ); ?></span><?php } else { ?><span class="social-count"><span class="social-count-num"><?php echo $soc_tot; ?></span> <span class="social-count-text"><?php _e( 'shares', 'mvp-text' ); ?></span><?php } ?>
	</div><!--share-count-->
