...
function get_portfolio() {
    if ( isset($_REQUEST) ) {
        $args = array( 'post_type' => 'post', 'posts_per_page' => 2, 'offset' => 2 );
...
add_action( 'get_wp_ajax_portfolio', 'get_portfolio' );
add_action( 'get_wp_ajax_nopriv_portfolio', 'get_portfolio' );