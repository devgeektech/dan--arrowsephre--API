		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				<tr valign="top">
					...
					<td>
						<input type="hidden" name="tps_nav[post_navigation]" value="false">
						<label>
							<input id="tps_post_navigation"
							       type="checkbox"
							       name="tps_nav[post_navigation]"
							       value="true"<?php echo $options['post_navigation'] ? ' checked' : '' ?>
							       onchange="updatePostNavigationReplieRee()"> Enable additional post navigation
						</label>
