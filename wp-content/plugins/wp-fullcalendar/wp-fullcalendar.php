...
class WP_FullCalendar{
	...
	public static function calendar( $args = array() ){
		...
		?>
		<style>
select.pec_switch_month {
    position: absolute;
    top: 0%;
    left: 24%;
    z-index: 1;
}select.pec_switch_year {
    position: absolute;
    top: 0;
    left: 60%;
    z-index: 2;
		...
		<div class="wpfc-calendar-wrapper" id="wpfc-calendar-wrapper"><form class="wpfc-calendar" id="wpfc-calendar"></form><select class="pec_switch_month" onChange="custoMonth(this.value)" >
					...
					<select class="pec_switch_year" onChange="yearFuntion(this.value)" name="birthdayYear"  >
					...
					<div class="wpfc-loading"></div></div>
