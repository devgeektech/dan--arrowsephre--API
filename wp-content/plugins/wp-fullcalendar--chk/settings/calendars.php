...
function dpProEventCalendar_calendars_page() {
	...
	<div style="clear:both;"></div>
 	...
 	<div id="dp_ui_content">
        ...
        <div id="leftSide">
        	<div id="dp_logo" style="float: left;
    width: 100%;
    text-align: center;
    margin: 19px 0px;
    font-size: 20px; 
color:#fff;">Full Calender</div>
                <p>
        ...
        <div id="rightSide">
        	<div id="menu_general_settings">
                ...
                <form action="<?php echo admin_url('admin.php?page=dpProEventCalendar-admin&noheader=true'); ?>" id="dpProEventCalendar_events_meta" method="post" enctype="multipart/form-data">
                    ...
                    <input type="hidden" name="remove_posts_calendar" value="1" />
                        ...
                        foreach($calendars_obj as $calendar) {
							...
							$args = array( 'numberposts' => -1, 'post_status' => 'publish', 'post_type' => 'pec-events' );
...
General settings</a>.','dpProEventCalendar'); ?></p>
                ...
                <div id="div_booking" style="display: none;">
                    ...
                    <div class="option option-select option_w">
                        <div class="option-inner">
                            ...
                            <div class="formcontainer">
                                ...
                                <div class="desc"><?php _e('Template of the email that will receive the event author. Use the reserved tags to display dynamic data. (#USERNAME#, #USEREMAIL, #COMMENT#, #EVENT_DETAILS#, #SITE_NAME#)','dpProEventCalendar'); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="clear"></div>
                    ...
                    <div class="option option-select option_w">
                        <div class="option-inner">
                            <label class="titledesc"><?php _e('Email that will receive the user as a reminder before the event','dpProEventCalendar'); ?></label>
                            <div class="formcontainer">
                                <div class="forminp">
...
Wordpress Multi Language plugin</a>.','dpProEventCalendar'); ?></p></div>
                    ...
                    <div id="div_translations_fields">
                			...
                			foreach($dpProEventCalendar_class->translation[$key] as $key2 => $value2) {
                				...
                				<div class="option option-select">
		                            <div class="option-inner">
		                                ...
		                                <div class="formcontainer">
		                                    <div class="forminp">
		                                        <input type="text" name="translation_fields[<?php echo strtolower($key)?>][<?php echo strtolower($key2)?>]" class="large-text" value="<?php echo $dpProEventCalendar_class->translation[$key][$key2]?>" />
		                                        <br>
		                                    </div>
		                                    <div class="desc"></div>
		                                </div>
                        ...
                        <div class="option option-select">
                            <div class="option-inner">
                                ...
                                <div class="formcontainer">
                                    <div class="forminp">
                                        <input type="text" name="translation_fields[<?php echo strtolower($key)?>]" class="large-text" value="<?php echo $dpProEventCalendar_class->translation[$key]?>" />
                                        <br>
                                    </div>
                                    <div class="desc"></div>
                                </div>
               ...
               <h2 class="subtitle accordion_title" onclick="showAccordion('div_sync');"><?php _e('Sync iCal Feed / Facebook Events','dpProEventCalendar'); ?></h2>
